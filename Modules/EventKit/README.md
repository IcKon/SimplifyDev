# EventKit
## Info
A simple Event Handler [Module](https://github.com/IcKon/SimplifyDev/tree/main/Modules/EventKit/EventKit.lua), allowing you to connect/attach functions globally, to a string category or an Instance without having to worry about creating those Instances. It also optionally allows Client-Server communication.
